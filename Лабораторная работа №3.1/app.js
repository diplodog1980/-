...
//задание2
 let customer = {
  ...
  if (user1.age > 21) {
    console.log(`${users.name} сделал(а) заказ на сумму ${order.total} в ресторане ${restaurant.name}, коорый находится в "${restaurant.location}".`);
  }
  ...
  let user2 = new User("Вася");
  
  console.log(user2.name); // Вася
